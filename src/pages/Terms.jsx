...
const InfoCard = ({ iconClass, title, content }) => (
    <div className="bg-gray-100 p-6 h-full rounded-xl shadow-sm text-center">
        <i className={`${iconClass} text-3xl ${ACCENT_COLOR_CLASS} mb-3`}></i>
        <h3 className={`text-lg font-semibold ${ACCENT_COLOR_CLASS} mb-2`}>{title}</h3>
        <p className="text-sm text-gray-700">{content}</p>
    </div>
);

const PolicyBox = ({ iconClass, title, children, accentBorderColor = 'border-blue-500' }) => (
    <div className={`bg-blue-50 p-6 h-full rounded-xl shadow-sm border-l-4 ${accentBorderColor}`}>
        <div className="flex items-center mb-4">
            <i className={`${iconClass} text-2xl ${ACCENT_COLOR_CLASS} mr-3`}></i>
            <h3 className={`text-xl font-semibold ${ACCENT_COLOR_CLASS}`}>{title}</h3>
        </div>
        {children}
    </div>
);
    ...
    return (
        ...
        <>
            ...
            <div className="font-sans bg-gray-50 min-h-screen text-gray-800">
                ...
                {/* Header Section (Uses Vibrant Magenta Accent) */}
                    ...
                    <div className="max-w-7xl mx-auto px-6 pb-16">
                        ...
                        <div className="bg-gray-100 p-8 rounded-xl mb-12 shadow-md">
                            <p className="text-lg leading-relaxed text-gray-700">
                                Welcome to **Tererang**. We are committed to providing a transparent and satisfying shopping experience built on elegance and trust. Please review our store policies carefully before placing an order. By accessing or using our website, and by making a purchase, you agree to be bound by these terms and conditions.
                            </p>
                        ...
                        <div className="space-y-12">
                            ...
                            <div className="bg-white p-8 shadow-lg border border-gray-200 rounded-xl">
                                ...
                                <h3 className={`text-xl font-semibold ${ACCENT_COLOR_CLASS} mt-6 mb-2`}>Product Images and Colors</h3>
                                <p className="text-gray-700">
                                ...
                                <h3 className={`text-xl font-semibold ${ACCENT_COLOR_CLASS} mt-6 mb-2`}>Size Information (Mandatory Check)</h3>
                                <div className="bg-gray-100 p-4 rounded-xl">
                                    <p className="font-bold text-gray-800 mb-3">Important Size Guidelines</p>
                                    <ul className="list-disc list-inside space-y-2 text-gray-600 ml-4">
                                        <li>Please **always refer to our specific size chart** before placing your order.</li>
                            ...
                            <div className="bg-white p-8 shadow-lg border border-gray-200 rounded-xl">
                                ...
                                <h3 className={`text-xl font-semibold ${ACCENT_COLOR_CLASS} mt-6 mb-2`}>Governing Law</h3>
                                <p className="text-gray-700">
                        ...
                        <div className="mt-12 text-center bg-gray-100 p-8 shadow-md rounded-xl">
                            <p className={`text-xl font-bold ${ACCENT_COLOR_CLASS} mb-3`}>
