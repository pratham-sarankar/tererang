...
import { ShoppingCart, Sparkles, Truck, Shield, ArrowRight, Shirt, Package, Crown } from "lucide-react";
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-16">
          <div className="text-center">
            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-4 py-1.5 mb-4">
              ...
              <span className="text-xs font-semibold tracking-wide">PREMIUM ETHNIC WEAR</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center group p-4 rounded-xl hover:bg-white transition duration-300">
              ...
              <h3 className="text-lg font-bold text-gray-900 mb-1">Curated Selection</h3>
      ...
      <section id="shop-categories" className="py-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { name: 'Kurtis', icon: Shirt, path: '/products/Kurti', color: 'from-purple-500 to-pink-500', desc: 'Elegant & versatile' },
              { name: 'Suits', icon: Package, path: '/products/Suit', color: 'from-blue-500 to-purple-500', desc: 'Traditional charm' },
              { name: 'Coats', path: '/products/Coat', icon: Sparkles, color: 'from-yellow-500 to-orange-500', desc: 'Modern elegance' }
            ].map((category, index) => (
              <div
                key={index}
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-br ${category.color} opacity-0 group-hover:opacity-90 transition duration-300`}></div>
      ...
      {/* Latest Collection */}
      <section id="latest-collection" className="py-10 bg-gradient-to-b from-purple-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          ...
          {loading && !error && (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 animate-pulse">
              {Array.from({ length: 8 }, (_, index) => index + 1).map((item) => (
                <div key={`skeleton-${item}`} className="bg-white rounded-2xl shadow-lg p-6 h-96" />
              ))}
            </div>
          )}
          ...
          {!error && !loading && enrichedProducts.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 text-sm">Check back soon for our latest collection!</p>
            </div>
          )}
      ...
      <section className="py-12 bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10 text-center">
          ...
          <p className="text-base sm:text-lg text-purple-100 mb-6 max-w-3xl mx-auto leading-relaxed">
            Join thousands of satisfied customers who trust Tererang for authentic,
            high-quality ethnic wear delivered in 7-9 days.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <button
              onClick={() => {
