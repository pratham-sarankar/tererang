...
const PolicyAccordionItem = ({ icon, title, content, isOpen, toggleAccordion }) => {
    ...
    <div className="border-b border-gray-200">
      ...
      >
        <div className="flex items-center">
          <IconComponent className={`w-6 h-6 mr-4 transition duration-300 ${isOpen ? 'text-cyan-700' : 'text-gray-500'}`} />
